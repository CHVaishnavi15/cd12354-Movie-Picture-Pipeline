...
resource "aws_eks_node_group" "main" {
  ...
  subnet_ids = [
    var.enable_private == true ? aws_subnet.private_subnet.id : aws_subnet.public_subnet.id
  ]

  # Do not specify ami_type.
  # The provider will use the default AMI type compatible with the EKS version.
...
# Disabled because the AWS Academy/CloudLab role
# does not have iam:PutUserPolicy permission.
#
